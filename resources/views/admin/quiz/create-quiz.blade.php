							...
							<div class="card-body">
								...
								<div class="row">
									<div class="col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12 mx-auto">
										<div>
											<form action="{{route('admin.store.quiz')}}" method="POST" enctype="multipart/form-data">
												@csrf
												...
												<div class="form-group">
													...
													<select name="article_content_id" id="article_content_id" class="form-control" required>
														...
														@foreach ($articleContents as $article_content)
															<option value="{{$article_content->id}}">{{$article_content->content_subtitle}}</option>
														@endforeach
													</select>
												</div>
												<div class="form-group">
													<label for="title" class="mb-2">Title</label>
													<input type="text" class="form-control" name="title" id="title" placeholder="Enter quiz title" required>
												</div>
												<div class="form-group">
													<label for="description" class="mb-2">Description</label>
													<input type="text" class="form-control" name="description" id="description" placeholder="Enter quiz description" required>
												</div>
												<div class="form-group">
