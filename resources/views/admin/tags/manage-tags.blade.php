						...
						<div class="card">
										...
										<div class="flex-grow-1 px-30 flex-grow-1 bg-img dask-bg bg-none-md" style="background-position: right bottom; background-size: auto 100%; background-image: url({{asset('ed_admin/images/svg-icon/color-svg/custom-1.svg')}})">
											<div class="row">
												<div class="col-12 col-xl-7">
													<h3 class="fw-bolder">All Tags</h3>
												</div>
											</div>
										</div>
									</div>
							...
							<div class="card-body">
								...
								<div class="d-flex justify-content-end mb-3">
									<a href="{{route('create.tags')}}" class="btn btn-success btn-sm"><i class="fa-solid fa-plus"></i></i> Add New</a>
								</div>
												...
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<div class="modal-body">
															<a href="{{route('destory.tags', $rows->id)}}" class="btn btn-danger mt-2">Permanent Delete</a>
														</div>
